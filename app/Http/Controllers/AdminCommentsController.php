<?php namespace App\Http\Controllers;
	...
	class AdminCommentsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Post","name"=>"posts_id","join"=>"posts,title"];
			...
			$this->form[] = ['label'=>'Post','name'=>'posts_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'posts,title'];
			...
			//$this->form[] = ["label"=>"Posts Id","name"=>"posts_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"posts,title"];
			# OLD END FORM
